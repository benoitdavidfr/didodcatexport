...
// Génération de l'export non paginé du catalogue DCAT
header('Content-type: application/ld+json; charset="utf-8"');
$json = json_encode(
  [
    ...
    '@graph'=> array_merge(
      ...
      [catalog(array_merge(RefNom::dsUris(), $datasetUris))], // Le catalogue référencant les datasets et les référentiels
      //[catalog(RefNom::dsUris())], // Le catalogue référencant les référentiels
      RefNom::jsonld(), // Les référentiels et nomenclatures
