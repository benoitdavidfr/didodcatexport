...
Les principes suivants ont été retenus pour l'exposition DCAT:
  ...
  - L'export DCAT est exposé à l'URL `https://dido.geoapi.fr/v1/dcatexport.{fmt}?page={page}&page_size={page_size}` où:
  ...
  - Chaque ressource de l'export est identifiée par un URI conforme aux modèles ci-dessous sauf pour les fichiers
    annexes (Attachment) pour lesquels l'URI associé est l'URL de téléchargement du fichier.
